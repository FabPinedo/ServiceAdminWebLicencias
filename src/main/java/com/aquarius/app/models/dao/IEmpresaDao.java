...
public interface IEmpresaDao extends JpaRepository<Empresa, Long> {
	...
	public List<Empresa> findByRazonsocialListadoActivos(@Param("razonsocial") String razonsocial);
	//
	@Query(nativeQuery = true, value= "SELECT * FROM LICENCIA_EMPRESA A WHERE A.CODIGO_RUC like %:ruc%")
	...
	public List< Empresa> findByRucListadoActivos(@Param("ruc") String ruc);
	//
